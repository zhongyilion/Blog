          ...
          <div class="review-version">
              <div class="form-box">
                <div class="article-cont">
                  <div class="title">
                    <%--<h3>爷爷买街边小吃已经30多年</h3>--%>
                    <h3>${sessionScope.article.title}</h3>
                    <p class="cont-info"><span class="data">${sessionScope.article.time}</span><span class="types">${sessionScope.article.user.nickname}</span></p>
                  </div>

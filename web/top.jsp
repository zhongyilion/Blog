...
<div class="header">
    ...
    <div class="nav">
        ...
        <%
        }else  if(nowpage!=null&&request.getParameter("nowPage").equals("about")){
        %>
        ...
        <%
            ...
            else  if(nowpage!=null&&request.getParameter("nowPage").equals("album")){
        %>
        <a href="index.jsp">文章</a>
        <a href="whisper.jsp">微语</a>
        <a href="leacots.jsp">留言</a>
        ...
        <%
            ...
            else  if(nowpage!=null&&request.getParameter("nowPage").equals("leacots")){
        %>
        <a href="index.jsp">文章</a>
        <a href="whisper.jsp">微语</a>
        ...
        <%
            ...
            else  if(nowpage!=null&&request.getParameter("nowPage").equals("whisper")){
        %>
        <a href="index.jsp">文章</a>
